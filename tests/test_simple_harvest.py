...
#     vault.deposit(amount, {"from": whale, 'gas_limit':'1 gwei', 'gas_price':'1 wei'})
...
#
#     crvGauge = Contract("0x78CF256256C8089d68Cde634Cf7cDEFb39286470")
#     gno = Contract(strategy.gno())
#
#
#     tx = crvGauge.claim_rewards(strategy, {"from":strategy})
#     tx = strategy.harvest({"from": gov})
#     gno.balanceOf(strategy)
#     assert False
#
#
